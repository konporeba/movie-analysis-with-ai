...
function vco({ title, alt, pad = 14 }) {
  ...
  o.visualTooltip = [{ properties: { show: B(true), type: S('Default'), background: C('#0A1B3D'), transparency: D(10), titleFontColor: C('#7DE3F4'), valueFontColor: C('#FFFFFF'), fontSize: D(8) } }];
...
const theme = {
  ...
  visualStyles: {
    '*': { '*': {
      ...
      visualTooltip: [{ show: true, type: 'Default', background: txt('#0A1B3D'), themedBackground: txt('#0A1B3D'), transparency: 10, titleFontColor: txt('#7DE3F4'), themedTitleFontColor: txt('#7DE3F4'), valueFontColor: txt('#FFFFFF'), themedValueFontColor: txt('#FFFFFF'), fontSize: 8 }],
